...
- **Right**: Large rock formation with warm illuminated surfaces
...
- Liquid White base for smooth sky blending
- Possible pre-painted gradient for warm sunset foundation

---

```yaml
tags:
  composition_archetype: "Desert Sunset Silhouette"
