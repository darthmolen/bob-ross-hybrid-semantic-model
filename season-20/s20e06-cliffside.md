# Season 20, Episode 6 — "Cliffside" (1990)
...
**Right:** The massive cliff formation dominates, rising from bottom to top, creating a strong vertical anchor and establishing scale for the entire composition.

**Left and Center:** Multiple wave formations build from background to foreground, creating rhythmic horizontal bands that contrast with the cliff's verticality.

**Foreground:** The nearest wave surges prominently across the lower portion, its crest brilliantly white and detailed, establishing the viewer's proximity to the action.

**Middle Ground:** Secondary waves roll and break, creating depth through overlapping forms and diminishing detail.

**Background:** The distant ocean meets the horizon line, which sits relatively low in the composition, while the moody sky extends upward, occupying the upper third.
...
The cliff achieves its texture through bold knife work, with vertical strokes defining the striated rock face and sharp edges catching highlights. The palette knife pulls dark mixtures downward to suggest weathered layers and ancient geological formations. Wave crests receive enthusiastic knife application, with thick Titanium White pushed and pulled to create dimensional foam and spray. The technique captures both the weight of water and its explosive lightness. Darker wave valleys likely use thinner paint with brush blending to suggest depth and transparency. The sky employs soft brush blending, creating smooth gradations from warm to cool tones without harsh transitions. Horizontal brush strokes in the distant ocean suggest vast expanses and calm water beyond the breaking zone. Spray and mist effects use dry-brush or fan brush techniques, creating fine texture that contrasts with the bold knife work. The painting demonstrates masterful control of both delicate atmospheric effects and aggressive, energetic mark-making where waves demand attention.

## 7. Narrative Layer

"Here stands a sentinel of stone, witness to ten thousand storms and ten thousand sunsets, each wave a temporary visitor to shores eternal. The ocean throws itself against the cliff not in anger but in endless conversation, a dialogue between fluid and solid that predates memory. In this golden hour, the violence becomes beautiful, the chaos reveals pattern, and the viewer stands safely distant from forces that would humble any human claim to permanence. This is nature's theater, performing the same ancient drama with infinite variation."

## 8. Initial Canvas Treatment

The canvas received an underpainting treatment using Black Gesso, establishing a dark foundation that shows through in the deepest shadows of both water and rock. This dark base allows the cliff's shadowed crevices to recede dramatically while making the white wave foam appear even more luminous by contrast. The black gesso creates atmospheric depth in the sky's darker tones and provides richness to the ocean's valleys. This foundation enables a "dark to light" painting approach, where highlights and mid-tones are built up over the darkness, creating the dramatic tonal range essential to the painting's powerful impact. The gesso layer also provides texture for subsequent knife work, allowing the cliff's surface to develop dimensional character.
